...
import (
	...
	v1alpha1 "kubeform.dev/provider-vsphere-api/client/listers/file/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FileV1alpha1().Files(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FileV1alpha1().Files(namespace).Watch(context.TODO(), options)
			},
		},
		&filev1alpha1.File{},
		resyncPeriod,
...
func (f *fileInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&filev1alpha1.File{}, f.defaultInformer)
}
