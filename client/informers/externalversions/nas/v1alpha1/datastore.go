...
import (
	...
	v1alpha1 "kubeform.dev/provider-vsphere-api/client/listers/nas/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NasV1alpha1().Datastores(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NasV1alpha1().Datastores(namespace).Watch(context.TODO(), options)
			},
		},
		&nasv1alpha1.Datastore{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *datastoreInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nasv1alpha1.Datastore{}, f.defaultInformer)
}
