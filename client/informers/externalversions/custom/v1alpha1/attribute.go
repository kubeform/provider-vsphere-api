...
import (
	...
	v1alpha1 "kubeform.dev/provider-vsphere-api/client/listers/custom/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CustomV1alpha1().Attributes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CustomV1alpha1().Attributes(namespace).Watch(context.TODO(), options)
			},
		},
		&customv1alpha1.Attribute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *attributeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&customv1alpha1.Attribute{}, f.defaultInformer)
}
