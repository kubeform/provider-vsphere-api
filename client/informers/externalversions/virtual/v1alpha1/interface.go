...
type Interface interface {
	...
	// MachineSnapshots returns a MachineSnapshotInformer.
	MachineSnapshots() MachineSnapshotInformer
}
...
// MachineSnapshots returns a MachineSnapshotInformer.
func (v *version) MachineSnapshots() MachineSnapshotInformer {
	return &machineSnapshotInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
