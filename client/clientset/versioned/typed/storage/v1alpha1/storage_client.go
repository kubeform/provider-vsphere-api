...
type StorageV1alpha1Interface interface {
	...
	DrsVmOverridesGetter
}

// StorageV1alpha1Client is used to interact with features provided by the storage.vsphere.kubeform.com group.
type StorageV1alpha1Client struct {
	restClient rest.Interface
}

func (c *StorageV1alpha1Client) DrsVmOverrides(namespace string) DrsVmOverrideInterface {
	return newDrsVmOverrides(c, namespace)
}
