...
func NewForConfig(c *rest.Config) (*ContentV1alpha1Client, error) {
	...
	return &ContentV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ContentV1alpha1Client for the given config and
...
func New(c rest.Interface) *ContentV1alpha1Client {
	return &ContentV1alpha1Client{c}
}
