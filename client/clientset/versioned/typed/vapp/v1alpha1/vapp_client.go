...
type VappV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*VappV1alpha1Client, error) {
	...
	return &VappV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new VappV1alpha1Client for the given config and
