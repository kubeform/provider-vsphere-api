...
type FakeLicenses struct {
	Fake *FakeLicenseV1alpha1
	ns   string
}

var licensesResource = schema.GroupVersionResource{Group: "license.vsphere.kubeform.com", Version: "v1alpha1", Resource: "licenses"}

var licensesKind = schema.GroupVersionKind{Group: "license.vsphere.kubeform.com", Version: "v1alpha1", Kind: "License"}
