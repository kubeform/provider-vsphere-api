...
// NasV1alpha1Client is used to interact with features provided by the nas.vsphere.kubeform.com group.
type NasV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NasV1alpha1Client) Datastores(namespace string) DatastoreInterface {
