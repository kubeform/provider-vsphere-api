...
type FakeDatastores struct {
	Fake *FakeVmfsV1alpha1
	ns   string
}

var datastoresResource = schema.GroupVersionResource{Group: "vmfs.vsphere.kubeform.com", Version: "v1alpha1", Resource: "datastores"}

var datastoresKind = schema.GroupVersionKind{Group: "vmfs.vsphere.kubeform.com", Version: "v1alpha1", Kind: "Datastore"}

// Get takes name of the datastore, and returns the corresponding datastore object, and an error if there is any.
func (c *FakeDatastores) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Datastore, err error) {
	obj, err := c.Fake.
...
func (c *FakeDatastores) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatastoreList, err error) {
	obj, err := c.Fake.
...
func (c *FakeDatastores) Create(ctx context.Context, datastore *v1alpha1.Datastore, opts v1.CreateOptions) (result *v1alpha1.Datastore, err error) {
	obj, err := c.Fake.
...
func (c *FakeDatastores) Update(ctx context.Context, datastore *v1alpha1.Datastore, opts v1.UpdateOptions) (result *v1alpha1.Datastore, err error) {
	obj, err := c.Fake.
...
func (c *FakeDatastores) UpdateStatus(ctx context.Context, datastore *v1alpha1.Datastore, opts v1.UpdateOptions) (*v1alpha1.Datastore, error) {
	obj, err := c.Fake.
...
func (c *FakeDatastores) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Datastore, err error) {
	obj, err := c.Fake.
