...
type ComputeV1alpha1Interface interface {
	...
	ClustersGetter
	ClusterHostGroupsGetter
	ClusterVmAffinityRulesGetter
	ClusterVmAntiAffinityRulesGetter
	ClusterVmDependencyRulesGetter
	ClusterVmGroupsGetter
	ClusterVmHostRulesGetter
}
