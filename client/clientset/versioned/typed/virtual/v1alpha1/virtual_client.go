...
type VirtualV1alpha1Interface interface {
	...
	DisksGetter
	MachinesGetter
	MachineSnapshotsGetter
}

// VirtualV1alpha1Client is used to interact with features provided by the virtual.vsphere.kubeform.com group.
type VirtualV1alpha1Client struct {
	restClient rest.Interface
}

func (c *VirtualV1alpha1Client) Disks(namespace string) DiskInterface {
...
func (c *VirtualV1alpha1Client) MachineSnapshots(namespace string) MachineSnapshotInterface {
	return newMachineSnapshots(c, namespace)
}
