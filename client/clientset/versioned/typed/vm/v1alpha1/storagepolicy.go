...
func newStoragePolicies(c *VmV1alpha1Client, namespace string) *storagePolicies {
...
func (c *storagePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StoragePolicy, err error) {
...
func (c *storagePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StoragePolicyList, err error) {
...
func (c *storagePolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *storagePolicies) Create(ctx context.Context, storagePolicy *v1alpha1.StoragePolicy, opts v1.CreateOptions) (result *v1alpha1.StoragePolicy, err error) {
	result = &v1alpha1.StoragePolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagepolicies").
...
func (c *storagePolicies) Update(ctx context.Context, storagePolicy *v1alpha1.StoragePolicy, opts v1.UpdateOptions) (result *v1alpha1.StoragePolicy, err error) {
	result = &v1alpha1.StoragePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagepolicies").
...
func (c *storagePolicies) UpdateStatus(ctx context.Context, storagePolicy *v1alpha1.StoragePolicy, opts v1.UpdateOptions) (result *v1alpha1.StoragePolicy, err error) {
	result = &v1alpha1.StoragePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagepolicies").
...
func (c *storagePolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *storagePolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *storagePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StoragePolicy, err error) {
	result = &v1alpha1.StoragePolicy{}
