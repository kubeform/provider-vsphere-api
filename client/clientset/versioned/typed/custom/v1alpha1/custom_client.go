...
// CustomV1alpha1Client is used to interact with features provided by the custom.vsphere.kubeform.com group.
type CustomV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CustomV1alpha1Client) Attributes(namespace string) AttributeInterface {
