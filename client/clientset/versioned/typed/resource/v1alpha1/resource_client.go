...
import (
	v1alpha1 "kubeform.dev/provider-vsphere-api/apis/resource/v1alpha1"
...
// ResourceV1alpha1Client is used to interact with features provided by the resource.vsphere.kubeform.com group.
type ResourceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ResourceV1alpha1Client) Pools(namespace string) PoolInterface {
