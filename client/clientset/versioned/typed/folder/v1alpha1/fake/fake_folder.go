...
var foldersResource = schema.GroupVersionResource{Group: "folder.vsphere.kubeform.com", Version: "v1alpha1", Resource: "folders"}

var foldersKind = schema.GroupVersionKind{Group: "folder.vsphere.kubeform.com", Version: "v1alpha1", Kind: "Folder"}
