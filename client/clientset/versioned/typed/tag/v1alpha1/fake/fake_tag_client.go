...
import (
	v1alpha1 "kubeform.dev/provider-vsphere-api/client/clientset/versioned/typed/tag/v1alpha1"
...
func (c *FakeTagV1alpha1) Categories(namespace string) v1alpha1.CategoryInterface {
